...
public class Order {
    ...
    public Order(String naruto, String uchiha, String address, String metroStation, String phone, int rentTime, String deliveryDate, String comment, List<String> color){
